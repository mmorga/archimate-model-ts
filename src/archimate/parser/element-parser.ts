...
export class ElementParser {
  ...
  parseArchimateElement(el: Element, type: ElementType) {
  ...
  parseArchimateRelationship(el: Element, type: RelationshipType) {
  ...
  handleElement(el: Element) {
    const t = el.attributes.getNamedItemNS("http://www.w3.org/2001/XMLSchema-instance", "type");
    if (t === null) {
      throw "Couldn't find element type";
    }
    // const attr = t as Attr;
    ...
    switch(typeStr) {
      ...
      case ElementType.BusinessCollaborationElementType:
        this.parseArchimateElement(el, ElementType.BusinessCollaborationElementType);
        break;
      ...
      case ElementType.BusinessInteractionElementType:
        this.parseArchimateElement(el, ElementType.BusinessInteractionElementType);
        break;
      case ElementType.BusinessInterfaceElementType:
        this.parseArchimateElement(el, ElementType.BusinessInterfaceElementType);
        break;
      ...
      case ElementType.ApplicationCollaborationElementType:
        this.parseArchimateElement(el, ElementType.ApplicationCollaborationElementType);
        break;
      case ElementType.ApplicationComponentElementType:
        this.parseArchimateElement(el, ElementType.ApplicationComponentElementType);
        break;
      ...
      case ElementType.ApplicationFunctionElementType:
        this.parseArchimateElement(el, ElementType.ApplicationFunctionElementType);
        break;
      case ElementType.ApplicationInteractionElementType:
        this.parseArchimateElement(el, ElementType.ApplicationInteractionElementType);
        break;
      case ElementType.ApplicationInterfaceElementType:
        this.parseArchimateElement(el, ElementType.ApplicationInterfaceElementType);
        break;
      case ElementType.ApplicationProcessElementType:
        this.parseArchimateElement(el, ElementType.ApplicationProcessElementType);
        break;
      case ElementType.ApplicationServiceElementType:
        this.parseArchimateElement(el, ElementType.ApplicationServiceElementType);
        break;
      ...
      case ElementType.CommunicationNetworkElementType:
        this.parseArchimateElement(el, ElementType.CommunicationNetworkElementType);
        break;
      case ElementType.CommunicationPathElementType:
        this.parseArchimateElement(el, ElementType.CommunicationPathElementType);
        break;
      ...
      case ElementType.InfrastructureFunctionElementType:
        this.parseArchimateElement(el, ElementType.InfrastructureFunctionElementType);
        break;
      case ElementType.InfrastructureInterfaceElementType:
        this.parseArchimateElement(el, ElementType.InfrastructureInterfaceElementType);
        break;
      case ElementType.InfrastructureServiceElementType:
        this.parseArchimateElement(el, ElementType.InfrastructureServiceElementType);
        break;
      ...
      case ElementType.TechnologyCollaborationElementType:
        this.parseArchimateElement(el, ElementType.TechnologyCollaborationElementType);
        break;
      ...
      case ElementType.TechnologyFunctionElementType:
        this.parseArchimateElement(el, ElementType.TechnologyFunctionElementType);
        break;
      case ElementType.TechnologyInteractionElementType:
        this.parseArchimateElement(el, ElementType.TechnologyInteractionElementType);
        break;
      case ElementType.TechnologyInterfaceElementType:
        this.parseArchimateElement(el, ElementType.TechnologyInterfaceElementType);
        break;
      ...
      case ElementType.TechnologyProcessElementType:
        this.parseArchimateElement(el, ElementType.TechnologyProcessElementType);
        break;
      case ElementType.TechnologyServiceElementType:
        this.parseArchimateElement(el, ElementType.TechnologyServiceElementType);
        break;
      case ElementType.DistributionNetworkElementType:
        this.parseArchimateElement(el, ElementType.DistributionNetworkElementType);
        break;
      ...
      case ElementType.ImplementationEventElementType:
        this.parseArchimateElement(el, ElementType.ImplementationEventElementType);
        break;
